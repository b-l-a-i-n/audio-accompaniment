...
$jscomp.polyfill("Symbol",function(a){if(a)return a;var b=function(h,l){this.$jscomp$symbol$id_=h;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:l})};b.prototype.toString=function(){return this.$jscomp$symbol$id_};var c="jscomp_symbol_"+(1E9*Math.random()>>>0)+"_",d=0,e=function(h){if(this instanceof e)throw new TypeError("Symbol is not a constructor");return new b(c+(h||"")+"_"+d++,h)};return e},"es6","es3");
...
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var f=Object.seal({}),k=Object.seal({}),m=new a([[f,2],[k,3]]);if(2!=m.get(f)||3!=m.get(k))return!1;m.delete(f);m.set(k,4);return!m.has(f)&&4==m.get(k)}catch(p){return!1}}function c(){}function d(f){var k=typeof f;return"object"===k&&null!==f||"function"===k}function e(f){if(!$jscomp.owns(f,l)){var k=new c;$jscomp.defineProperty(f,l,{value:k})}}function h(f){if(!$jscomp.ISOLATE_POLYFILLS){var k=Object[f];k&&(Object[f]=
function(m){if(m instanceof c)return m;Object.isExtensible(m)&&e(m);return k(m)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var l="$jscomp_hidden_"+Math.random();h("freeze");h("preventExtensions");h("seal");var n=0,g=function(f){this.id_=(n+=Math.random()+1).toString();if(f){f=$jscomp.makeIterator(f);for(var k;!(k=f.next()).done;)k=k.value,this.set(k[0],k[1])}};g.prototype.set=function(f,k){if(!d(f))throw Error("Invalid WeakMap key");
e(f);if(!$jscomp.owns(f,l))throw Error("WeakMap key fail: "+f);f[l][this.id_]=k;return this};g.prototype.get=function(f){return d(f)&&$jscomp.owns(f,l)?f[l][this.id_]:void 0};g.prototype.has=function(f){return d(f)&&$jscomp.owns(f,l)&&$jscomp.owns(f[l],this.id_)};g.prototype.delete=function(f){return d(f)&&$jscomp.owns(f,l)&&$jscomp.owns(f[l],this.id_)?delete f[l][this.id_]:!1};return g},"es6","es3");$jscomp.MapEntry=function(){};
...
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var c=new WeakMap,d=function(g){this.data_={};this.head_=l();this.size=0;if(g){g=$jscomp.makeIterator(g);for(var f;!(f=g.next()).done;)f=f.value,this.set(f[0],f[1])}};d.prototype.set=function(g,f){g=0===g?0:g;var k=e(this,g);k.list||(k.list=this.data_[k.id]=[]);k.entry?k.entry.value=f:(k.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:g,value:f},k.list.push(k.entry),
this.head_.previous.next=k.entry,this.head_.previous=k.entry,this.size++);return this};d.prototype.delete=function(g){g=e(this,g);return g.entry&&g.list?(g.list.splice(g.index,1),g.list.length||delete this.data_[g.id],g.entry.previous.next=g.entry.next,g.entry.next.previous=g.entry.previous,g.entry.head=null,this.size--,!0):!1};d.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=l();this.size=0};d.prototype.has=function(g){return!!e(this,g).entry};d.prototype.get=function(g){return(g=
e(this,g).entry)&&g.value};d.prototype.entries=function(){return h(this,function(g){return[g.key,g.value]})};d.prototype.keys=function(){return h(this,function(g){return g.key})};d.prototype.values=function(){return h(this,function(g){return g.value})};d.prototype.forEach=function(g,f){for(var k=this.entries(),m;!(m=k.next()).done;)m=m.value,g.call(f,m[1],m[0],this)};d.prototype[Symbol.iterator]=d.prototype.entries;var e=function(g,f){var k=f&&typeof f;"object"==k||"function"==k?c.has(f)?k=c.get(f):
(k=""+ ++n,c.set(f,k)):k="p_"+f;var m=g.data_[k];if(m&&$jscomp.owns(g.data_,k))for(g=0;g<m.length;g++){var p=m[g];if(f!==f&&p.key!==p.key||f===p.key)return{id:k,list:m,index:g,entry:p}}return{id:k,list:m,index:-1,entry:void 0}},h=function(g,f){var k=g.head_;return $jscomp.iteratorPrototype(function(){if(k){for(;k.head!=g.head_;)k=k.previous;for(;k.next!=k.head;)return k=k.next,{done:!1,value:f(k)};k=null}return{done:!0,value:void 0}})},l=function(){var g={};return g.previous=g.next=g.head=g},n=0;
...
goog.exportPath_=function(a,b,c,d){a=a.split(".");d=d||goog.global;a[0]in d||"undefined"==typeof d.execScript||d.execScript("var "+a[0]);for(var e;a.length&&(e=a.shift());)if(a.length||void 0===b)d=d[e]&&d[e]!==Object.prototype[e]?d[e]:d[e]={};else if(!c&&goog.isObject(b)&&goog.isObject(d[e]))for(var h in b)b.hasOwnProperty(h)&&(d[e][h]=b[h]);else d[e]=b};
...
goog.getCssName=function(a,b){if("."==String(a).charAt(0))throw Error('className passed in goog.getCssName must not start with ".". You passed: '+a);var c=function(e){return goog.cssNameMapping_[e]||e},d=function(e){e=e.split("-");for(var h=[],l=0;l<e.length;l++)h.push(c(e[l]));return h.join("-")};d=goog.cssNameMapping_?"BY_WHOLE"==goog.cssNameMappingStyle_?c:d:function(e){return e};a=b?a+"-"+d(b):d(a);return goog.global.CLOSURE_CSS_NAME_MAP_FN?goog.global.CLOSURE_CSS_NAME_MAP_FN(a):a};
...
[];this.depsToLoad_=[];this.paused_=!1;this.factory_=new goog.DependencyFactory;this.deferredCallbacks_={};this.deferredQueue_=[]},goog.DebugLoader_.prototype.bootstrap=function(a,b){function c(){d&&(goog.global.setTimeout(d,0),d=null)}var d=b;if(a.length){b=[];for(var e=0;e<a.length;e++){var h=this.getPathFromDeps_(a[e]);if(!h)throw Error("Unregonized namespace: "+a[e]);b.push(this.dependencies_[h])}h=goog.require;var l=0;for(e=0;e<a.length;e++)h(a[e]),b[e].onLoad(function(){++l==a.length&&c()})}else c()},
goog.DebugLoader_.prototype.loadClosureDeps=function(){this.depsToLoad_.push(this.factory_.createDependency(goog.normalizePath_(goog.basePath+"deps.js"),"deps.js",[],[],{}));this.loadDeps_()},goog.DebugLoader_.prototype.requested=function(a,b){(a=this.getPathFromDeps_(a))&&(b||this.areDepsLoaded_(this.dependencies_[a].requires))&&(b=this.deferredCallbacks_[a])&&(delete this.deferredCallbacks_[a],b())},goog.DebugLoader_.prototype.setDependencyFactory=function(a){this.factory_=a},goog.DebugLoader_.prototype.load_=
function(a){if(this.getPathFromDeps_(a)){var b=this,c=[],d=function(e){var h=b.getPathFromDeps_(e);if(!h)throw Error("Bad dependency path or symbol: "+e);if(!b.written_[h]){b.written_[h]=!0;e=b.dependencies_[h];for(h=0;h<e.requires.length;h++)goog.isProvided_(e.requires[h])||d(e.requires[h]);c.push(e)}};d(a);a=!!this.depsToLoad_.length;this.depsToLoad_=this.depsToLoad_.concat(c);this.paused_||a||this.loadDeps_()}else goog.logToConsole_("goog.require could not find: "+a)},goog.DebugLoader_.prototype.loadDeps_=
function(){for(var a=this,b=this.paused_;this.depsToLoad_.length&&!b;)(function(){var c=!1,d=a.depsToLoad_.shift(),e=!1;a.loading_(d);var h={pause:function(){if(c)throw Error("Cannot call pause after the call to load.");b=!0},resume:function(){c?a.resume_():b=!1},loaded:function(){if(e)throw Error("Double call to loaded.");e=!0;a.loaded_(d)},pending:function(){for(var l=[],n=0;n<a.loadingDeps_.length;n++)l.push(a.loadingDeps_[n]);return l},setModuleState:function(l){goog.moduleLoaderState_={type:l,
moduleName:"",declareLegacyNamespace:!1}},registerEs6ModuleExports:function(l,n,g){g&&(goog.loadedModules_[g]={exports:n,type:goog.ModuleType.ES6,moduleId:g||""})},registerGoogModuleExports:function(l,n){goog.loadedModules_[l]={exports:n,type:goog.ModuleType.GOOG,moduleId:l}},clearModuleState:function(){goog.moduleLoaderState_=null},defer:function(l){if(c)throw Error("Cannot register with defer after the call to load.");a.defer_(d,l)},areDepsLoaded:function(){return a.areDepsLoaded_(d.requires)}};
try{d.load(h)}finally{c=!0}})();b&&this.pause_()},goog.DebugLoader_.prototype.pause_=function(){this.paused_=!0},goog.DebugLoader_.prototype.resume_=function(){this.paused_&&(this.paused_=!1,this.loadDeps_())},goog.DebugLoader_.prototype.loading_=function(a){this.loadingDeps_.push(a)},goog.DebugLoader_.prototype.loaded_=function(a){for(var b=0;b<this.loadingDeps_.length;b++)if(this.loadingDeps_[b]==a){this.loadingDeps_.splice(b,1);break}for(b=0;b<this.deferredQueue_.length;b++)if(this.deferredQueue_[b]==
...
b.readyState&&!goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING){if(/\bdeps.js$/.test(this.path)){a.loaded();return}throw Error('Cannot write "'+this.path+'" after document load');}var c=goog.getScriptNonce_();if(!goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING&&goog.isDocumentLoading_()){var d=function(n){n.readyState&&"complete"!=n.readyState?n.onload=d:(goog.Dependency.unregisterCallback_(e),a.loaded())};var e=goog.Dependency.registerCallback_(d);c=c?' nonce="'+c+'"':"";var h='<script src="'+this.path+'"'+
c+(goog.Dependency.defer_?" defer":"")+' id="script-'+e+'">\x3c/script>';h+="<script"+c+">";h=goog.Dependency.defer_?h+("document.getElementById('script-"+e+"').onload = function() {\n  goog.Dependency.callback_('"+e+"', this);\n};\n"):h+("goog.Dependency.callback_('"+e+"', document.getElementById('script-"+e+"'));");h+="\x3c/script>";b.write(goog.TRUSTED_TYPES_POLICY_?goog.TRUSTED_TYPES_POLICY_.createHTML(h):h)}else{var l=b.createElement("script");l.defer=goog.Dependency.defer_;l.async=!1;c&&(l.nonce=
c);l.onload=function(){l.onload=null;a.loaded()};l.src=goog.TRUSTED_TYPES_POLICY_?goog.TRUSTED_TYPES_POLICY_.createScriptURL(this.path):this.path;b.head.appendChild(l)}}else goog.logToConsole_("Cannot use default debug loader outside of HTML documents."),"deps.js"==this.relativePath?(goog.logToConsole_("Consider setting CLOSURE_IMPORT_SCRIPT before loading base.js, or setting CLOSURE_NO_DEPS to true."),a.loaded()):a.pause()},goog.Es6ModuleDependency=function(a,b,c,d,e){goog.Dependency.call(this,a,
b,c,d,e)},goog.inherits(goog.Es6ModuleDependency,goog.Dependency),goog.Es6ModuleDependency.prototype.load=function(a){function b(f,k){var m="",p=goog.getScriptNonce_();p&&(m=' nonce="'+p+'"');f=k?'<script type="module" crossorigin'+m+">"+k+"\x3c/script>":'<script type="module" crossorigin src="'+f+'"'+m+">\x3c/script>";d.write(goog.TRUSTED_TYPES_POLICY_?goog.TRUSTED_TYPES_POLICY_.createHTML(f):f)}function c(f,k){var m=d.createElement("script");m.defer=!0;m.async=!1;m.type="module";m.setAttribute("crossorigin",
!0);var p=goog.getScriptNonce_();p&&(m.nonce=p);k?m.text=goog.TRUSTED_TYPES_POLICY_?goog.TRUSTED_TYPES_POLICY_.createScript(k):k:m.src=goog.TRUSTED_TYPES_POLICY_?goog.TRUSTED_TYPES_POLICY_.createScriptURL(f):f;d.head.appendChild(m)}if(goog.global.CLOSURE_IMPORT_SCRIPT)goog.global.CLOSURE_IMPORT_SCRIPT(this.path)?a.loaded():a.pause();else if(goog.inHtmlDocument_()){var d=goog.global.document,e=this;if(goog.isDocumentLoading_()){var h=b;goog.Dependency.defer_=!0}else h=c;var l=goog.Dependency.registerCallback_(function(){goog.Dependency.unregisterCallback_(l);
a.setModuleState(goog.ModuleType.ES6)});h(void 0,'goog.Dependency.callback_("'+l+'")');h(this.path,void 0);var n=goog.Dependency.registerCallback_(function(f){goog.Dependency.unregisterCallback_(n);a.registerEs6ModuleExports(e.path,f,goog.moduleLoaderState_.moduleName)});h(void 0,'import * as m from "'+this.path+'"; goog.Dependency.callback_("'+n+'", m)');var g=goog.Dependency.registerCallback_(function(){goog.Dependency.unregisterCallback_(g);a.clearModuleState();a.loaded()});h(void 0,'goog.Dependency.callback_("'+
g+'")')}else goog.logToConsole_("Cannot use default debug loader outside of HTML documents."),a.pause()},goog.TransformedDependency=function(a,b,c,d,e){goog.Dependency.call(this,a,b,c,d,e);this.contents_=null;this.lazyFetch_=!goog.inHtmlDocument_()||!("noModule"in goog.global.document.createElement("script"))},goog.inherits(goog.TransformedDependency,goog.Dependency),goog.TransformedDependency.prototype.load=function(a){function b(){e.contents_=goog.loadFileSync_(e.path);e.contents_&&(e.contents_=
e.transform(e.contents_),e.contents_&&(e.contents_+="\n//# sourceURL="+e.path))}function c(){e.lazyFetch_&&b();if(e.contents_){h&&a.setModuleState(goog.ModuleType.ES6);try{var f=e.contents_;e.contents_=null;goog.globalEval(goog.CLOSURE_EVAL_PREFILTER_.createScript(f));if(h)var k=goog.moduleLoaderState_.moduleName}finally{h&&a.clearModuleState()}h&&goog.global.$jscomp.require.ensure([e.getPathName()],function(){a.registerEs6ModuleExports(e.path,goog.global.$jscomp.require(e.getPathName()),k)});a.loaded()}}
function d(){var f=goog.global.document,k=goog.Dependency.registerCallback_(function(){goog.Dependency.unregisterCallback_(k);c()}),m=goog.getScriptNonce_();m="<script"+(m?' nonce="'+m+'"':"")+">"+goog.protectScriptTag_('goog.Dependency.callback_("'+k+'");')+"\x3c/script>";f.write(goog.TRUSTED_TYPES_POLICY_?goog.TRUSTED_TYPES_POLICY_.createHTML(m):m)}var e=this;if(goog.global.CLOSURE_IMPORT_SCRIPT)b(),this.contents_&&goog.global.CLOSURE_IMPORT_SCRIPT("",this.contents_)?(this.contents_=null,a.loaded()):
a.pause();else{var h=this.loadFlags.module==goog.ModuleType.ES6;this.lazyFetch_||b();var l=1<a.pending().length;if(goog.Dependency.defer_&&(l||goog.isDocumentLoading_()))a.defer(function(){c()});else{var n=goog.global.document;l=goog.inHtmlDocument_()&&("ActiveXObject"in goog.global||goog.isEdge_());if(h&&goog.inHtmlDocument_()&&goog.isDocumentLoading_()&&!l){goog.Dependency.defer_=!0;a.pause();var g=n.onreadystatechange;n.onreadystatechange=function(){"interactive"==n.readyState&&(n.onreadystatechange=
g,c(),a.resume());"function"===typeof g&&g.apply(void 0,arguments)}}else goog.inHtmlDocument_()&&goog.isDocumentLoading_()?d():c()}}},goog.TransformedDependency.prototype.transform=function(a){},goog.PreTranspiledEs6ModuleDependency=function(a,b,c,d,e){goog.TransformedDependency.call(this,a,b,c,d,e)},goog.inherits(goog.PreTranspiledEs6ModuleDependency,goog.TransformedDependency),goog.PreTranspiledEs6ModuleDependency.prototype.transform=function(a){return a},goog.GoogModuleDependency=function(a,b,
...
forceTransmux:!0},lcevc:{enabled:!0,dynamicPerformanceScaling:!0,logLevel:0,drawLogo:!1}})];
